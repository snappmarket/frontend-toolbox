...
const FilePreviewIcon = ({ className, size }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M15 0h-9c-1.103 0-2 0.897-2 2v8h2v-8h9v4.5c0 0.275 0.225 0.5 0.5 0.5h4.5v15h-14v-3h-2v3c0 1.103 0.897 2 2 2h14c1.103 0 2-0.897 2-2v-15c0-3.859-3.141-7-7-7zM16 6v-3.9c1.956 0.4 3.5 1.944 3.9 3.9h-3.9z"></path>
