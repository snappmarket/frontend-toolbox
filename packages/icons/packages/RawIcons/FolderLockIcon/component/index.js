...
const FolderLockIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M15.5 14h-0.5v-1c0-1.653-1.347-3-3-3s-3 1.347-3 3v1h-0.5c-0.275 0-0.5 0.225-0.5 0.5v4c0 0.275 0.225 0.5 0.5 0.5h7c0.275 0 0.5-0.225 0.5-0.5v-4c0-0.275-0.225-0.5-0.5-0.5zM10 13c0-1.103 0.897-2 2-2s2 0.897 2 2v1h-4v-1zM15 18h-6v-3h6v3z"></path>
  </svg>
);
