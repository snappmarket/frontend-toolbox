...
const VolumeCrossIcon = ({ className, size }) => (
  <svg
    data-testid="VolumeCrossIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M20.206 9.5l-0.706-0.706-2.5 2.5-2.5-2.5-0.706 0.706 2.5 2.5-2.5 2.5 0.706 0.706 2.5-2.5 2.5 2.5 0.706-0.706-2.5-2.5z"></path>
  </svg>
);

VolumeCrossIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

VolumeCrossIcon.defaultProps = {
  size: 1.5,
};
