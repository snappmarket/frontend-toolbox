...
const TongueIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M18.341 12.025c-3.912 1.303-8.772 1.303-12.684 0l-0.475-0.159-0.316 0.95 0.475 0.159c1.156 0.384 2.391 0.663 3.659 0.831v2.197c0 1.653 1.347 3 3 3s3-1.347 3-3v-2.197c1.269-0.169 2.503-0.444 3.659-0.831l0.475-0.159-0.316-0.95-0.478 0.159zM14 16c0 1.103-0.897 2-2 2s-2-0.897-2-2v-2.084c0.663 0.056 1.331 0.087 2 0.087s1.338-0.028 2-0.087v2.084z"></path>
  </svg>
);
