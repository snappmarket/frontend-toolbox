...
const Weight1kgIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M11.206 15.456l-0.75-0.663-1.456 1.647v-3.441h-1v6h1v-1.047l0.116-0.131 1.384 1.384 0.706-0.706-1.428-1.428z"></path>
    <path d="M15 15.269c-0.294-0.172-0.638-0.269-1-0.269-1.103 0-2 0.897-2 2s0.897 2 2 2c0.363 0 0.706-0.097 1-0.269v0.269c0 0.55-0.45 1-1 1h-2v1h2c1.103 0 2-0.897 2-2v-4h-1v0.269zM14 18c-0.55 0-1-0.45-1-1s0.45-1 1-1 1 0.45 1 1-0.45 1-1 1z"></path>
  </svg>
);
