...
const DrawerDownloadIcon = ({ className, size }) => (
  <svg
    data-testid="DrawerDownloadIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
