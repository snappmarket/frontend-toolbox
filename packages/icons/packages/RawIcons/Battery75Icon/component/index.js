...
const Battery75Icon = ({ className, size }) => (
  <svg
    data-testid="Battery75Icon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M3 8h1v8h-1v-8zM5 16h1v-8h-1v8zM7 16h1v-8h-1v8zM9 16h1v-8h-1v8zM11 16h1v-8h-1v8zM13 16h1v-8h-1v8z"></path>
  </svg>
);

Battery75Icon.propTypes = {
