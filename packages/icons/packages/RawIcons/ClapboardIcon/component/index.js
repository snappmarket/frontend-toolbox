...
const ClapboardIcon = ({ className, size }) => (
  <svg
    data-testid="ClapboardIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
