...
const CrossCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M15.537 7.050l-3.537 3.534-3.537-3.534-1.413 1.413 3.534 3.537-3.534 3.537 1.413 1.413 3.537-3.534 3.537 3.534 1.413-1.413-3.534-3.537 3.534-3.537z"></path>
  </svg>
);
