...
const UploadSquareIcon = ({ className, size }) => (
  <svg
    data-testid="UploadSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M11 9.416v7.584h-3v1h8v-1h-3v-7.584l2.544 2.544 1.416-1.416-4.25-4.25c-0.391-0.391-1.025-0.391-1.416 0l-4.25 4.25 1.416 1.416 2.541-2.544z"></path>
...
UploadSquareIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

UploadSquareIcon.defaultProps = {
  size: 1.5,
};
