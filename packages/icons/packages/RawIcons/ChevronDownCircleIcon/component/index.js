...
const ChevronDownCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M12 13.584l-4.544-4.541-1.416 1.416 5.25 5.25c0.194 0.194 0.45 0.294 0.706 0.294s0.513-0.097 0.706-0.294l5.25-5.25-1.416-1.416-4.537 4.541z"></path>
  </svg>
);
