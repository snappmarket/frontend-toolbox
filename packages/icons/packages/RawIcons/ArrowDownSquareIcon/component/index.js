...
const ArrowDownSquareIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M12 18c0.256 0 0.513-0.097 0.706-0.294l4.25-4.25-1.416-1.416-2.541 2.544v-8.584h-2v8.584l-2.544-2.544-1.416 1.416 4.25 4.25c0.197 0.197 0.453 0.294 0.709 0.294z"></path>
  </svg>
);
