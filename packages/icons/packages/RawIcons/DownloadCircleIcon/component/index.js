...
const DownloadCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M16.956 12.456l-1.416-1.416-2.541 2.544v-7.584h-2v7.584l-2.544-2.544-1.416 1.416 4.25 4.25c0.194 0.194 0.45 0.294 0.706 0.294s0.513-0.097 0.706-0.294l4.253-4.25z"></path>
  </svg>
);
