...
const SprayIcon = ({ className, size }) => (
  <svg
    data-testid="SprayIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
