...
const UploadCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M15.544 11.956l1.416-1.416-4.25-4.25c-0.391-0.391-1.025-0.391-1.416 0l-4.25 4.25 1.416 1.416 2.544-2.544v7.587h-3v1h8v-1h-3v-7.584l2.541 2.541z"></path>
  </svg>
);
