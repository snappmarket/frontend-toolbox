...
const CloudBackupIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M20.147 13.147l-1.353 1.353 0.706 0.706 0.5-0.5v0.794c0 1.378-1.122 2.5-2.5 2.5s-2.5-1.122-2.5-2.5 1.122-2.5 2.5-2.5h0.5v-1h-0.5c-1.931 0-3.5 1.569-3.5 3.5s1.569 3.5 3.5 3.5 3.5-1.569 3.5-3.5v-0.794l0.5 0.5 0.706-0.706-1.353-1.353c-0.194-0.197-0.513-0.197-0.706 0z"></path>
  </svg>
);
