...
const BubblePictureIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M17.5 6h-10c-0.275 0-0.5 0.225-0.5 0.5v8c0 0.275 0.225 0.5 0.5 0.5h10c0.275 0 0.5-0.225 0.5-0.5v-8c0-0.275-0.225-0.5-0.5-0.5zM8 7h9v4.169l-0.584-0.584c-0.781-0.778-2.050-0.778-2.828 0l-3.416 3.416h-2.172v-7zM11.584 14l2.709-2.709c0.387-0.387 1.025-0.387 1.416 0l1.291 1.291v1.419h-5.416z"></path>
    <path d="M10.5 11c0.828 0 1.5-0.672 1.5-1.5s-0.672-1.5-1.5-1.5-1.5 0.672-1.5 1.5 0.672 1.5 1.5 1.5zM10.5 9c0.275 0 0.5 0.225 0.5 0.5s-0.225 0.5-0.5 0.5-0.5-0.225-0.5-0.5 0.225-0.5 0.5-0.5z"></path>
  </svg>
);
