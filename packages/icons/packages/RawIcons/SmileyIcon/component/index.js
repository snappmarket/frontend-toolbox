...
const SmileyIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M12 19c-3.859 0-7-3.141-7-7h-1c0 2.138 0.831 4.147 2.344 5.656s3.519 2.344 5.656 2.344 4.147-0.831 5.656-2.344 2.344-3.519 2.344-5.656h-1c0 3.859-3.141 7-7 7z"></path>
  </svg>
);
