...
const BubbleShinyIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M18.762 6.825c-1.622-1.159-3.906-1.825-6.262-1.825h-0.5v1h0.5c2.153 0 4.225 0.597 5.681 1.638 0.678 0.488 1.819 1.503 1.819 2.862v0.5h1v-0.5c0-1.806-1.403-3.078-2.238-3.675z"></path>
  </svg>
);
