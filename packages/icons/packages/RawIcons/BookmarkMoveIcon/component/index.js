...
const BookmarkMoveIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M20.853 6.147l-1.353-1.353-0.706 0.706 0.5 0.5h-5.588l0.5-0.5-0.706-0.706-1.353 1.353c-0.194 0.194-0.194 0.513 0 0.706l1.353 1.353 0.706-0.706-0.5-0.5h5.584l-0.5 0.5 0.706 0.706 1.353-1.353c0.2-0.194 0.2-0.513 0.003-0.706z"></path>
  </svg>
);
