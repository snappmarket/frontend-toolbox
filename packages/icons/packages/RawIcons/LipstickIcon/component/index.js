...
const LipstickIcon = ({ className, size }) => (
  <svg
    data-testid="LipstickIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
