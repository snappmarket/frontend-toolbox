...
const ChecklistIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M5.794 9.5l0.706-0.706 1 1 3-3 0.706 0.706-3.353 3.353c-0.097 0.097-0.225 0.147-0.353 0.147s-0.256-0.050-0.353-0.147l-1.353-1.353zM10.5 10.794l-3 3-1-1-0.706 0.706 1.353 1.353c0.097 0.097 0.225 0.147 0.353 0.147s0.256-0.050 0.353-0.147l3.353-3.353-0.706-0.706zM6.5 16.794l-0.706 0.706 1.353 1.353c0.097 0.097 0.225 0.147 0.353 0.147s0.256-0.050 0.353-0.147l3.353-3.353-0.706-0.706-3 3-1-1z"></path>
    <path d="M18 10h-6v-1h6v1zM18 13h-6v1h6v-1zM12 18h6v-1h-6v1z"></path>
  </svg>
);
