...
const ClipboardTextIcon = ({ className, size }) => (
  <svg
    data-testid="ClipboardTextIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M17 8h-10v-1h10v1zM13 10h-6v1h6v-1zM17 12h-10v1h10v-1zM15 14h-8v1h8v-1zM17 16h-10v1h10v-1zM16 18h-9v1h9v-1z"></path>
  </svg>
);
...
ClipboardTextIcon.defaultProps = {
  size: 1.5,
};
