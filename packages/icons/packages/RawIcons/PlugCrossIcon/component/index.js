...
const PlugCrossIcon = ({ className, size }) => (
  <svg
    data-testid="PlugCrossIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
