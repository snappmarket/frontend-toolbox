...
const CloudSnowIcon = ({ className, size }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M3 19c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
    <path d="M9 19c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
    <path d="M15 19c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
    <path d="M21 19c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
    <path d="M6 22c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
    <path d="M12 22c-0.55 0-1 0.45-1 1s0.45 1 1 1c0.55 0 1-0.45 1-1s-0.45-1-1-1z"></path>
    <path d="M18 22c-0.55 0-1 0.45-1 1s0.45 1 1 1 1-0.45 1-1-0.45-1-1-1z"></path>
