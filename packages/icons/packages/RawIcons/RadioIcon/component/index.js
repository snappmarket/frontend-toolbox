...
const RadioIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M5.5 15c1.378 0 2.5-1.122 2.5-2.5s-1.122-2.5-2.5-2.5-2.5 1.122-2.5 2.5 1.122 2.5 2.5 2.5zM5.5 11c0.653 0 1.209 0.419 1.416 1h-0.916v1h0.916c-0.206 0.581-0.762 1-1.416 1-0.828 0-1.5-0.672-1.5-1.5s0.672-1.5 1.5-1.5z"></path>
    <path d="M3 18h2v1h-2v-1z"></path>
    <path d="M6 18h2v1h-2v-1z"></path>
  </svg>
);
