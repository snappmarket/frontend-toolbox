...
const SmartphoneLockIcon = ({ className, size }) => (
  <svg
    data-testid="SmartphoneLockIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M18.5 11h-0.5v-0.5c0-1.378-1.122-2.5-2.5-2.5s-2.5 1.122-2.5 2.5v0.5h-0.5c-0.275 0-0.5 0.225-0.5 0.5v3c0 0.275 0.225 0.5 0.5 0.5h6c0.275 0 0.5-0.225 0.5-0.5v-3c0-0.275-0.225-0.5-0.5-0.5zM14 10.5c0-0.828 0.672-1.5 1.5-1.5s1.5 0.672 1.5 1.5v0.5h-3v-0.5zM18 14h-5v-2h5v2z"></path>
  </svg>
);

SmartphoneLockIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

SmartphoneLockIcon.defaultProps = {
  size: 1.5,
};
