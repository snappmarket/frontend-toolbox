...
const NextSquareIcon = ({ className, size }) => (
  <svg
    data-testid="NextSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
