...
const BubbleVideoIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M17.5 7h-10c-0.275 0-0.5 0.225-0.5 0.5v6c0 0.275 0.225 0.5 0.5 0.5h10c0.275 0 0.5-0.225 0.5-0.5v-6c0-0.275-0.225-0.5-0.5-0.5zM17 9h-1v-1h1v1zM9 11h-1v-1h1v1zM10 8h5v5h-5v-5zM16 10h1v1h-1v-1zM9 8v1h-1v-1h1zM8 12h1v1h-1v-1zM16 13v-1h1v1h-1z"></path>
  </svg>
);
