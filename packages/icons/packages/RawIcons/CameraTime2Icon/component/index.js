...
const CameraTime2Icon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M17.5 9c0.016 0 0.034 0 0.050-0.003 0.15-0.016 0.284-0.097 0.366-0.219l2.278-3.416-0.831-0.556-1.938 2.909-1.925-1.922-0.706 0.706 2.353 2.353c0.094 0.094 0.222 0.147 0.353 0.147z"></path>
  </svg>
);
