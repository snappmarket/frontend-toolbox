...
const PlotterIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M20 4h1v1h-1v-1z"></path>
    <path d="M10 13c-1.103 0-2 0.897-2 2s0.897 2 2 2 2-0.897 2-2-0.897-2-2-2zM10 16c-0.55 0-1-0.45-1-1s0.45-1 1-1 1 0.45 1 1-0.45 1-1 1z"></path>
  </svg>
);
