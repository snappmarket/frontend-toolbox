...
const BellRingingIcon = ({ className, size }) => (
  <svg
    data-testid="BellRingingIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
