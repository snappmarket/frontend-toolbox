...
const LampBrightIcon = ({ className, size }) => (
  <svg
    data-testid="LampBrightIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M21 7h3v1h-3v-1z"></path>
    <path d="M19.828 2.277l2.896-1.448 0.447 0.894-2.896 1.448-0.447-0.894z"></path>
    <path d="M19.828 12.724l0.447-0.894 2.896 1.448-0.447 0.894-2.896-1.448z"></path>
    <path d="M0 7h3v1h-3v-1z"></path>
    <path d="M0.828 1.723l0.447-0.894 2.896 1.448-0.447 0.894-2.896-1.448z"></path>
    <path d="M0.828 13.277l2.896-1.448 0.447 0.894-2.896 1.448-0.447-0.894z"></path>
  </svg>
);

LampBrightIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

LampBrightIcon.defaultProps = {
  size: 1.5,
};

export default LampBrightIcon;
