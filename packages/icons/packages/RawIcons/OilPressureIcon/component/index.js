...
const OilPressureIcon = ({ className, size }) => (
  <svg
    data-testid="OilPressureIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
