...
const MagnifierPrevIcon = ({ className, size }) => (
  <svg
    data-testid="MagnifierPrevIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M16.206 5.5l-0.706-0.706-2.353 2.353c-0.194 0.194-0.194 0.513 0 0.706l2.353 2.353 0.706-0.706-1.5-1.5h5.294v-1h-5.294l1.5-1.5z"></path>
  </svg>
);

MagnifierPrevIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

MagnifierPrevIcon.defaultProps = {
  size: 1.5,
};

export default MagnifierPrevIcon;
