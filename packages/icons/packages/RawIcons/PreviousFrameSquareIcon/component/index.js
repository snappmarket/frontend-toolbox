...
const PreviousFrameSquareIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M7.247 12.431l6 3.5c0.078 0.047 0.166 0.069 0.253 0.069s0.172-0.022 0.25-0.066c0.156-0.091 0.25-0.253 0.25-0.434v-7c0-0.178-0.097-0.344-0.25-0.434s-0.347-0.087-0.5 0.003l-6 3.5c-0.153 0.091-0.247 0.253-0.247 0.431s0.091 0.344 0.244 0.431zM13 9.372v5.259l-4.506-2.631 4.506-2.628z"></path>
    <path d="M15 8h1v8h-1v-8z"></path>
  </svg>
);
