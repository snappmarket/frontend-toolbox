...
const BillRubleIcon = ({ className, size }) => (
  <svg
    data-testid="BillRubleIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M12 8h-1.5c-0.275 0-0.5 0.225-0.5 0.5v2.5h-1v1h1v1h-1v1h1v1h1v-1h2v-1h-2v-1h1c1.103 0 2-0.897 2-2s-0.897-2-2-2zM12 11h-1v-2h1c0.55 0 1 0.45 1 1s-0.45 1-1 1z"></path>
...
BillRubleIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

BillRubleIcon.defaultProps = {
  size: 1.5,
};

export default BillRubleIcon;
