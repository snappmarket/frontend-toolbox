...
const FileUserIcon = ({ className, size }) => (
  <svg
    data-testid="FileUserIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
