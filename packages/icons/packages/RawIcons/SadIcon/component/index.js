...
const SadIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M12 12c-1.847 0-3.706 1-5.853 3.147l-0.353 0.353 0.706 0.706 0.353-0.353c1.947-1.947 3.581-2.853 5.147-2.853s3.2 0.906 5.147 2.853l0.353 0.353 0.706-0.706-0.353-0.353c-2.147-2.147-4.006-3.147-5.853-3.147z"></path>
  </svg>
);
