...
const CheckSquareIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M10 17c0.256 0 0.513-0.097 0.706-0.294l7.25-7.25-1.416-1.416-6.541 6.544-2.544-2.544-1.416 1.416 3.25 3.25c0.197 0.197 0.453 0.294 0.709 0.294z"></path>
  </svg>
);
