...
const LockCheckIcon = ({ className, size }) => (
  <svg
    data-testid="LockCheckIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M18.5 4.794l-4 4-2-2-0.706 0.706 2.353 2.353c0.097 0.097 0.225 0.147 0.353 0.147s0.256-0.050 0.353-0.147l4.353-4.353-0.706-0.706z"></path>
  </svg>
);

LockCheckIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

LockCheckIcon.defaultProps = {
  size: 1.5,
};
