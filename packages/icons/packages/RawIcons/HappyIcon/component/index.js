...
const HappyIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M4 12.5c0 1.897 0.856 3.803 2.353 5.228 1.534 1.466 3.541 2.272 5.647 2.272s4.113-0.806 5.65-2.272c1.494-1.425 2.35-3.331 2.35-5.228 0-0.275-0.225-0.5-0.5-0.5h-15c-0.275 0-0.5 0.225-0.5 0.5zM18.978 13c-0.297 3.25-3.431 6-6.978 6s-6.681-2.75-6.978-6h13.956z"></path>
  </svg>
);
