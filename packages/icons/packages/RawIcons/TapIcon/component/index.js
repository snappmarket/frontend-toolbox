...
const TapIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M5.816 3.131l-3.947-1.316 0.316-0.95 3.95 1.316-0.319 0.95zM6.131 4.816l-0.316-0.95-3.947 1.319 0.316 0.95 3.947-1.319zM18.131 1.816l-0.316-0.95-3.947 1.319 0.316 0.95 3.947-1.319zM18.131 5.184l-3.95-1.316-0.316 0.95 3.95 1.316 0.316-0.95z"></path>
  </svg>
);
