...
const PencilRulerIcon = ({ className, size }) => (
  <svg
    data-testid="PencilRulerIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
