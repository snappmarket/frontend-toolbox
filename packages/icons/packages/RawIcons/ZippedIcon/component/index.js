...
const ZippedIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M18 11h-1v1h-1v-1h-1v1h-1v-1h-1v1h-1v-1h-1v1h-1v-1h-1v1h-1v-1h-1v1h-1v-0.5c0-0.275-0.225-0.5-0.5-0.5h-2c-0.275 0-0.5 0.225-0.5 0.5v2c0 0.275 0.225 0.5 0.5 0.5h2c0.275 0 0.5-0.225 0.5-0.5v-0.5h2v1h1v-1h1v1h1v-1h1v1h1v-1h1v1h1v-1h1v1h1v-1h1.084c-0.056 0.156-0.084 0.325-0.084 0.5v2c0 0.275 0.225 0.5 0.5 0.5h2c0.275 0 0.5-0.225 0.5-0.5v-2c0-0.828-0.672-1.5-1.5-1.5h-1.5v-1zM5 13h-1v-1h1v1zM20 13.5v1.5h-1v-1.5c0-0.275 0.225-0.5 0.5-0.5s0.5 0.225 0.5 0.5z"></path>
  </svg>
);
