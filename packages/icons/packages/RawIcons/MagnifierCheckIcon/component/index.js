...
const MagnifierCheckIcon = ({ className, size }) => (
  <svg
    data-testid="MagnifierCheckIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M15.5 8.794l-2-2-0.706 0.706 2.353 2.353c0.097 0.097 0.225 0.147 0.353 0.147s0.256-0.050 0.353-0.147l4.353-4.353-0.706-0.706-4 4z"></path>
  </svg>
);

MagnifierCheckIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

MagnifierCheckIcon.defaultProps = {
  size: 1.5,
};

export default MagnifierCheckIcon;
