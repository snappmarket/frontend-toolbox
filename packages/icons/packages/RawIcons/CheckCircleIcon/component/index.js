...
const CheckCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M10 14.584l-2.544-2.544-1.416 1.416 3.25 3.25c0.194 0.194 0.45 0.294 0.706 0.294s0.513-0.097 0.706-0.294l7.25-7.25-1.416-1.416-6.537 6.544z"></path>
  </svg>
);
