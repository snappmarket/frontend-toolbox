...
const Wifi50Icon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M17.825 11.141c-1.619-1.378-3.687-2.137-5.822-2.137h-0.003c-2.134 0-4.2 0.759-5.822 2.134l-0.381 0.325 0.647 0.762 0.381-0.325c3-2.55 7.353-2.547 10.353 0.003l0.381 0.325 0.647-0.762-0.381-0.325z"></path>
  </svg>
);
