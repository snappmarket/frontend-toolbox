...
const SolarPanelIcon = ({ className, size }) => (
  <svg
    data-testid="SolarPanelIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
