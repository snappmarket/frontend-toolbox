...
const AnvilIcon = ({ className, size }) => (
  <svg
    data-testid="AnvilIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
