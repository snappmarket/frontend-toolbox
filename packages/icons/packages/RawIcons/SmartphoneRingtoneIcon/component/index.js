...
const SmartphoneRingtoneIcon = ({ className, size }) => (
  <svg
    data-testid="SmartphoneRingtoneIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M17 8h-1v4.131c-0.353-0.125-0.762-0.162-1.191-0.103-1.109 0.156-1.903 0.922-1.803 1.747 0.041 0.328 0.213 0.616 0.5 0.837 0.334 0.256 0.803 0.397 1.303 0.397 0.125 0 0.253-0.009 0.381-0.028 1.047-0.147 1.812-0.837 1.809-1.606v0-3.141c0.531 0.475 1.231 0.766 2 0.766v-1c-1.103 0-2-0.897-2-2zM15.050 13.991c-0.366 0.050-0.731-0.016-0.934-0.172-0.050-0.038-0.109-0.097-0.116-0.166-0.025-0.197 0.341-0.55 0.947-0.634 0.087-0.012 0.172-0.019 0.253-0.019 0.319 0 0.553 0.091 0.681 0.188 0.072 0.053 0.109 0.109 0.116 0.166v0c0.025 0.197-0.341 0.55-0.947 0.638z"></path>
  </svg>
);

SmartphoneRingtoneIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

SmartphoneRingtoneIcon.defaultProps = {
  size: 1.5,
};

export default SmartphoneRingtoneIcon;
