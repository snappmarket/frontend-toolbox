...
const LaptopEducationIcon = ({ className, size }) => (
  <svg
    data-testid="LaptopEducationIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
