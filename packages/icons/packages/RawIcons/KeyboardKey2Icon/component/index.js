...
const KeyboardKey2Icon = ({ className, size }) => (
  <svg
    data-testid="KeyboardKey2Icon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M12 6c-0.413 0-0.784 0.253-0.931 0.641l-4.25 11 1.866 0.722 1.297-3.363h4.038l1.297 3.359 1.866-0.722-4.25-11c-0.147-0.384-0.519-0.638-0.931-0.638zM10.753 13l1.247-3.225 1.247 3.225h-2.494z"></path>
  </svg>
);

KeyboardKey2Icon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

KeyboardKey2Icon.defaultProps = {
  size: 1.5,
};

export default KeyboardKey2Icon;
