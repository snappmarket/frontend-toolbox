...
const BatteryQuestionIcon = ({ className, size }) => (
  <svg
    data-testid="BatteryQuestionIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M9 8.5c0-1.103 0.809-1.497 1.503-1.497 0.4 0 0.788 0.125 1.062 0.344 0.288 0.228 0.434 0.531 0.434 0.903 0 0.713-0.434 1.084-0.941 1.519-0.497 0.425-1.059 0.906-1.059 1.731v0.5h1v-0.5c0-0.347 0.256-0.584 0.709-0.972 0.575-0.491 1.291-1.103 1.291-2.278 0-1.459-1.287-2.247-2.497-2.247-1.206 0-2.503 0.781-2.503 2.497v0.5h1v-0.5z"></path>
  </svg>
);

BatteryQuestionIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

BatteryQuestionIcon.defaultProps = {
  size: 1.5,
};

export default BatteryQuestionIcon;
