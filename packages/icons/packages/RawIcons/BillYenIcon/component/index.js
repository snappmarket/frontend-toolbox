...
const BillYenIcon = ({ className, size }) => (
  <svg
    data-testid="BillYenIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M14.206 9.5l-0.706-0.706-2 2-2-2-0.706 0.706 2.206 2.206v0.294h-2v1h2v1h-2v1h2v1h1v-1h2v-1h-2v-1h2v-1h-2v-0.294z"></path>
...
BillYenIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

BillYenIcon.defaultProps = {
  size: 1.5,
};

export default BillYenIcon;
