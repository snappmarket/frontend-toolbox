...
const CrossCircle2Icon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M14.538 8.050l-2.538 2.534-2.538-2.534-1.413 1.413 2.534 2.538-2.534 2.538 1.413 1.413 2.538-2.534 2.538 2.534 1.413-1.413-2.534-2.538 2.534-2.538z"></path>
  </svg>
);
