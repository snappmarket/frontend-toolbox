...
const BedCrossIcon = ({ className, size }) => (
  <svg
    data-testid="BedCrossIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M15.5 12.206l2-2 2 2 0.706-0.706-2-2 2-2-0.706-0.706-2 2-2-2-0.706 0.706 2 2-2 2z"></path>
  </svg>
);

BedCrossIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

BedCrossIcon.defaultProps = {
  size: 1.5,
};

export default BedCrossIcon;
