...
const WindowTabPlusIcon = ({ className, size }) => (
  <svg
    data-testid="WindowTabPlusIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
