...
const StopCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M15.5 8h-7c-0.275 0-0.5 0.225-0.5 0.5v7c0 0.275 0.225 0.5 0.5 0.5h7c0.275 0 0.5-0.225 0.5-0.5v-7c0-0.275-0.225-0.5-0.5-0.5zM15 15h-6v-6h6v6z"></path>
  </svg>
);
