...
const SmartphoneTimeIcon = ({ className, size }) => (
  <svg
    data-testid="SmartphoneTimeIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M15.422 11.716l-1.922-1.922-0.706 0.706 2.353 2.353c0.094 0.094 0.222 0.147 0.353 0.147 0.016 0 0.034 0 0.050-0.003 0.15-0.016 0.284-0.097 0.366-0.219l2.278-3.416-0.831-0.556-1.941 2.909z"></path>
  </svg>
);

SmartphoneTimeIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

SmartphoneTimeIcon.defaultProps = {
  size: 1.5,
};

export default SmartphoneTimeIcon;
