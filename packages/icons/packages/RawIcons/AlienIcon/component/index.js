...
const AlienIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M11 13.5c0-2.219-0.578-3.719-1.766-4.591-1.094-0.8-2.5-0.909-3.734-0.909-0.275 0-0.5 0.225-0.5 0.5 0 2.053 0.506 3.484 1.55 4.378 0.891 0.766 2.147 1.122 3.95 1.122 0.275 0 0.5-0.225 0.5-0.5zM6.012 9.009c0.931 0.031 1.903 0.175 2.631 0.706 0.828 0.606 1.272 1.681 1.347 3.275-2.294-0.097-3.831-0.909-3.978-3.981z"></path>
    <path d="M18.5 8c-1.234 0-2.641 0.109-3.734 0.909-1.188 0.872-1.766 2.372-1.766 4.591 0 0.275 0.225 0.5 0.5 0.5 1.803 0 3.059-0.356 3.95-1.122 1.044-0.894 1.55-2.325 1.55-4.378 0-0.275-0.225-0.5-0.5-0.5zM14.013 12.991c0.075-1.594 0.519-2.666 1.347-3.275 0.725-0.531 1.7-0.675 2.631-0.706-0.15 3.072-1.688 3.884-3.978 3.981z"></path>
    <path d="M10 17h4v1h-4v-1z"></path>
  </svg>
);
