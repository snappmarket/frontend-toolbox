...
const ArrowRightCircleIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M12.044 8.456l2.544 2.544h-8.587v2h8.584l-2.544 2.544 1.416 1.416 4.25-4.25c0.188-0.188 0.294-0.441 0.294-0.706s-0.106-0.519-0.294-0.706l-4.25-4.25-1.413 1.409z"></path>
  </svg>
);
