...
const QuestionSquareIcon = ({ className, size }) => (
  <svg
    data-testid="QuestionSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
...
QuestionSquareIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

QuestionSquareIcon.defaultProps = {
  size: 1.5,
};
