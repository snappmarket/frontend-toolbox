...
const CubeSideIcon = ({ className, size }) => (
  <svg
    data-testid="CubeSideIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M19.759 10.662c-0.15-0.091-0.334-0.097-0.487-0.019l-5 2.562c-0.166 0.084-0.272 0.256-0.272 0.444v4.381c0 0.175 0.091 0.334 0.241 0.428 0.081 0.050 0.169 0.072 0.259 0.072 0.078 0 0.156-0.019 0.228-0.056l5-2.562c0.166-0.084 0.272-0.256 0.272-0.444v-4.378c0-0.175-0.091-0.338-0.241-0.428zM19 15.166l-4 2.050v-3.256l4-2.050v3.256z"></path>
  </svg>
);

CubeSideIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

CubeSideIcon.defaultProps = {
  size: 1.5,
};

export default CubeSideIcon;
