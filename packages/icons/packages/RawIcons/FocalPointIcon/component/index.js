...
const FocalPointIcon = ({ className, size }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M0 2v6h2v-6h6v-2h-6c-1.103 0-2 0.897-2 2z"></path>
    <path d="M22 0h-6v2h6v6h2v-6c0-1.103-0.897-2-2-2z"></path>
    <path d="M22 22h-6v2h6c1.103 0 2-0.897 2-2v-6h-2v6z"></path>
    <path d="M2 16h-2v6c0 1.103 0.897 2 2 2h6v-2h-6v-6z"></path>
