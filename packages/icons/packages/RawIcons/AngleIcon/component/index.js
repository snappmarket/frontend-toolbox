...
const AngleIcon = ({ className, size }) => (
  <svg
    data-testid="AngleIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M16 10c-1.103 0-2 0.897-2 2s0.897 2 2 2 2-0.897 2-2c0-1.103-0.897-2-2-2zM16 13c-0.55 0-1-0.45-1-1s0.45-1 1-1 1 0.45 1 1-0.45 1-1 1z"></path>
  </svg>
);
