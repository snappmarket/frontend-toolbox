...
const RbFlaskIcon = ({ className, size }) => (
  <svg
    data-testid="RbFlaskIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
