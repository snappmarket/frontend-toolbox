...
const MagnifierNextIcon = ({ className, size }) => (
  <svg
    data-testid="MagnifierNextIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M17.5 4.794l-0.706 0.706 1.5 1.5h-5.294v1h5.294l-1.5 1.5 0.706 0.706 2.353-2.353c0.194-0.194 0.194-0.513 0-0.706l-2.353-2.353z"></path>
  </svg>
);

MagnifierNextIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

MagnifierNextIcon.defaultProps = {
  size: 1.5,
};

export default MagnifierNextIcon;
