...
const CoffeeMakerIcon = ({ className, size }) => (
  <svg
    data-testid="CoffeeMakerIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
