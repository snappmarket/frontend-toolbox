...
const ClipboardCheckIcon = ({ className, size }) => (
  <svg
    data-testid="ClipboardCheckIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M9.997 18c0 0 0 0 0 0 0.266 0 0.519-0.106 0.706-0.294l7.253-7.25-1.413-1.416-6.547 6.544-2.541-2.544-1.416 1.413 3.247 3.25c0.191 0.191 0.444 0.297 0.709 0.297z"></path>
  </svg>
);
