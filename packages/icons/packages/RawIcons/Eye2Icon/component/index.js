...
const Eye2Icon = ({ className, size }) => (
  <svg
    data-testid="Eye2Icon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
