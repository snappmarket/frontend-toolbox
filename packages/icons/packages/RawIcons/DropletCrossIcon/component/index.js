...
const DropletCrossIcon = ({ className, size }) => (
  <svg
    data-testid="DropletCrossIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M13.5 11.206l-0.706-0.706 2-2-2-2 0.706-0.706 2 2 2-2 0.706 0.706-2 2 2 2-0.706 0.706-2-2z"></path>
  </svg>
);

DropletCrossIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

DropletCrossIcon.defaultProps = {
  size: 1.5,
};

export default DropletCrossIcon;
