...
const ForwardSquareIcon = ({ className, size }) => (
  <svg
    data-testid="ForwardSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M8.256 14.937c0.075 0.041 0.159 0.063 0.244 0.063 0.091 0 0.184-0.025 0.266-0.075l3.234-2.022v1.597c0 0.181 0.1 0.35 0.256 0.438 0.075 0.041 0.159 0.063 0.244 0.063 0.091 0 0.184-0.025 0.266-0.075l4-2.5c0.147-0.091 0.234-0.253 0.234-0.425s-0.087-0.331-0.234-0.425l-4-2.5c-0.153-0.097-0.347-0.1-0.506-0.012s-0.256 0.256-0.256 0.438v1.597l-3.234-2.022c-0.153-0.097-0.347-0.1-0.506-0.012s-0.256 0.256-0.256 0.438v5c-0.006 0.181 0.094 0.35 0.25 0.438zM13 10.403l2.556 1.597-2.556 1.597v-3.194zM9 10.403l2.556 1.597-2.556 1.597v-3.194z"></path>
  </svg>
);

ForwardSquareIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

ForwardSquareIcon.defaultProps = {
  size: 1.5,
};
