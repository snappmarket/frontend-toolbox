...
const StopSquareIcon = ({ className, size }) => (
  <svg
    data-testid="StopSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M8.5 16h7c0.275 0 0.5-0.225 0.5-0.5v-7c0-0.275-0.225-0.5-0.5-0.5h-7c-0.275 0-0.5 0.225-0.5 0.5v7c0 0.275 0.225 0.5 0.5 0.5zM9 9h6v6h-6v-6z"></path>
  </svg>
);

StopSquareIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

StopSquareIcon.defaultProps = {
  size: 1.5,
};
