...
const NextFrameSquareIcon = ({ className, size }) => (
  <svg
    data-testid="NextFrameSquareIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
