...
const LaundryTimeIcon = ({ className, size }) => (
  <svg
    data-testid="LaundryTimeIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
    ...
    fill="currentColor"
  >
    <path d="M7 14h-1c0 2.206 1.794 4 4 4v-1c-1.653 0-3-1.347-3-3z"></path>
    <path d="M16 3h1v1h-1v-1z"></path>
    <path d="M3 3h2v1h-2v-1z"></path>
    <path d="M6 3h1v1h-1v-1z"></path>
...
LaundryTimeIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number,
};

LaundryTimeIcon.defaultProps = {
  size: 1.5,
};

export default LaundryTimeIcon;
