...
const CloudSyncIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M16.794 13.5l0.706 0.706 1.353-1.353c0.194-0.194 0.194-0.513 0-0.706l-1.353-1.353-0.706 0.706 0.506 0.506c-1.838 0.103-3.3 1.631-3.3 3.494v0.5h1v-0.5c0-1.306 1.006-2.381 2.284-2.491l-0.491 0.491z"></path>
    <path d="M20 15.5c0 1.306-1.006 2.381-2.284 2.491l0.491-0.491-0.706-0.706-1.353 1.353c-0.194 0.194-0.194 0.513 0 0.706l1.353 1.353 0.706-0.706-0.506-0.506c1.837-0.103 3.3-1.631 3.3-3.494v-0.5h-1v0.5z"></path>
  </svg>
);
