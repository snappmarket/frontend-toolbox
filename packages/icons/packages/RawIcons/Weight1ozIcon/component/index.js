...
const Weight1ozIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M15.963 15.309c-0.078-0.188-0.259-0.309-0.462-0.309h-3.5v1h2.294l-2.147 2.147c-0.144 0.144-0.184 0.359-0.109 0.544s0.259 0.309 0.462 0.309h3.5v-1h-2.294l2.147-2.147c0.144-0.144 0.188-0.356 0.109-0.544z"></path>
    <path d="M17 18h1v1h-1v-1z"></path>
    <path d="M9 15c-1.103 0-2 0.897-2 2s0.897 2 2 2 2-0.897 2-2-0.897-2-2-2zM9 18c-0.55 0-1-0.45-1-1s0.45-1 1-1 1 0.45 1 1-0.45 1-1 1z"></path>
  </svg>
);
