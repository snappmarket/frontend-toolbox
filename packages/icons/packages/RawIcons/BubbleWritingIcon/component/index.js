...
const BubbleWritingIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M14.853 7.147l-2-2c-0.194-0.194-0.513-0.194-0.706 0l-5.5 5.5c-0.069 0.069-0.119 0.159-0.138 0.256l-0.5 2.5c-0.031 0.162 0.019 0.334 0.138 0.453 0.094 0.094 0.222 0.147 0.353 0.147 0.031 0 0.066-0.003 0.097-0.009l2.5-0.5c0.097-0.019 0.184-0.066 0.256-0.138l5.5-5.5c0.197-0.197 0.197-0.516 0-0.709zM8.753 12.541l-1.616 0.322 0.322-1.616 5.041-5.041 1.294 1.294-5.041 5.041z"></path>
    <path d="M11 13h7v1h-7v-1z"></path>
  </svg>
);
