...
export const StyledAlertWrapper = Styled.div`
  ...
  props.theme.colors[props.color][props.colorShade]};
  padding: ${props =>
    `calc(${props.theme.defaultRem} * 0.8) calc(${props.theme.defaultRem} * 1.6) calc(${props.theme.defaultRem} * 0.8) calc(${props.theme.defaultRem} * 1.6)`};
`;
